...
export PYTHONPATH=common_layer/python:common_layer/python/domain:common_layer/python/infrastructure/system:common_layer/python/infrastructure/repository:send_scheduled_reminders/
